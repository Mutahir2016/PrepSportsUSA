...
extension TennisBoxScoreView {
    static func fromNib() -> TennisBoxScoreView? {
        let bundle = Bundle(for: TennisBoxScoreView.self)
        let nib = UINib(nibName: "TennisBoxScoreView", bundle: bundle)
        return nib.instantiate(withOwner: nil, options: nil).first as? TennisBoxScoreView
    }
}

class TennisBoxScoreView: UIView {
