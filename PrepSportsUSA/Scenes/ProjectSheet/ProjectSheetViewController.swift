//
//  ProjectSheetViewController.swift
//  Lumen
//
...
class ProjectSheetViewController: BaseViewController {
    ...
    var viewModel: ProjectSheetViewModel!
...
extension ProjectSheetViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.dismiss(animated: true) {
            self.viewModel.delegate?.projectSheet(self, didSelectProject: project, projectArr: self.originalProjects)
        }
    }
}
